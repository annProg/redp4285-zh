...
:::{#fig:process_thread}
```{#fig:process_thread_process .plot:dot caption="进程创建" width=48% height=200px subfig=1}
digraph task_struct {
    rankdir="LR"
    compound=true
    subgraph cluster_p {
...
```
```{#fig:process_thread_process .plot:dot caption="进程创建" width=48% height=180px subfig=1}
digraph task_struct {
    rankdir="TB"
    compound=true
